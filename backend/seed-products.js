...
if (!process.env.MONGODB_URI) {
  ...
  console.error(
    "Please create a .env file with MONGODB_URI or provide the connection string directly."
  );
  process.exit(1);
}
...
const productsData = [
  // GRAINS CATEGORY
  {
    name: "White Maize",
    description:
      "Locally grown white maize kernels, perfect for making traditional dishes. High in starch and essential vitamins.",
  ...
  },
  {
    name: "Yellow Maize",
    description:
      "Golden yellow maize with excellent nutritional profile, rich in carotenoids and vitamin A. Ideal for animal feed and food products.",
    price: getRandomPrice(3, 7),
    unit: "kg",
    quantity: getRandomQuantity(1000, 5000),
    category: "Grains",
  ...
  },
  {
    name: "Hard Red Wheat",
    description:
      "Premium high-protein wheat variety, perfect for bread making. Produces strong, elastic dough with excellent baking qualities.",
  ...
  },
  {
    name: "Basmati Rice",
    description:
      "Aromatic long-grain rice with distinctive fragrance. Grains remain separate when cooked, making it perfect for special dishes.",
  ...
  },
  {
    name: "Barley",
    description:
      "Versatile cereal grain used in brewing, animal feed, and food products. High in fiber and nutrients.",
  ...
  },
  {
    name: "White Sorghum",
    description:
      "Drought-resistant white sorghum, ideal for flour and porridge. Gluten-free with mild flavor profile.",
  ...
  },
  {
    name: "Red Sorghum",
    description:
      "High-tannin red sorghum, popular in brewing traditional beverages. Rich, earthy flavor with excellent storage properties.",
    price: getRandomPrice(4, 7),
    unit: "kg",
    quantity: getRandomQuantity(800, 2500),
    category: "Grains",
  ...
  },
  {
    name: "Brown Sorghum",
    description:
      "Nutrient-rich brown sorghum with balanced flavor profile. Excellent for animal feed and human consumption.",
    price: getRandomPrice(4, 7),
    unit: "kg",
    quantity: getRandomQuantity(800, 2500),
    category: "Grains",
  ...
  },
  {
    name: "Sweet Sorghum",
    description:
      "Sugary stems and grain make this variety ideal for syrup production and livestock feed. Natural sweetener alternative.",
    price: getRandomPrice(4, 8),
    unit: "kg",
    quantity: getRandomQuantity(800, 2500),
    category: "Grains",
  ...
  },
  {
    name: "Pearl Millet",
    description:
      "Hardy, drought-resistant grain with high nutritional value. Rich in iron, protein and fiber.",
    price: getRandomPrice(4, 7),
    unit: "kg",
  ...
  // LEGUMES CATEGORY
  {
    name: "Black Beans",
    description:
      "Glossy black beans with creamy texture and earthy flavor. Rich in protein and antioxidants.",
    price: getRandomPrice(5, 9),
    unit: "kg",
    quantity: getRandomQuantity(500, 2000),
    category: "Legumes",
  ...
  },
  {
    name: "Kidney Beans",
    description:
      "Dark red kidney-shaped beans that hold their shape during cooking. Ideal for stews and chili.",
    price: getRandomPrice(5, 9),
    unit: "kg",
    quantity: getRandomQuantity(500, 2000),
    category: "Legumes",
  ...
  // VEGETABLES CATEGORY - Add missing ones from your list
  {
    name: "Crown Broccoli",
    description:
      "Compact dark green heads with tight florets. Rich in vitamins K and C with exceptional flavor.",
    price: getRandomPrice(4, 8),
    unit: "kg",
  ...
  },
  {
    name: "Green Cabbage",
    description:
      "Dense, tightly packed heads with crisp texture. Versatile for cooking and perfect for slaw and fermentation.",
  ...
  // FRUITS CATEGORY
  {
    ...
    description:
      "Sweet, creamy texture with gentle aroma. The world's most popular banana variety.",
    price: getRandomPrice(3, 6),
    unit: "kg",
    quantity: getRandomQuantity(500, 2000),
    category: "Fruits",
  ...
  },
  {
    name: "Kent Mango",
    description:
      "Large, juicy mangoes with minimal fiber and rich, sweet flavor. Perfect balance of sweetness and acidity.",
...
async function runSeed() {
  try {
    ...
    if (existingCount > 12) {
      console.log(
        "Database already has more than the initial 12 products. Skipping seeding to avoid duplicates."
      );
      console.log(
        "If you want to reseed, please drop the products collection first."
      );
    ...
    console.log(
      "✅ Backup of existing products created at public/data/products-backup.json"
    );
    ...
    console.log(
      `✅ Successfully added ${result.length} new products to the database!`
    );
    console.log(
      `📊 Total products in database now: ${await Product.countDocuments()}`
    );
    ...
    console.log(
      "✅ Created products.json fallback file at public/data/products.json"
    );
